...
/* ─── SHARE BUTTONS ─── */
const SHARE_URL = "https://promptjur.com";
const SHARE_TEXT = "Conheça o PromptJur — prompts jurídicos profissionais para advogados que produzem melhor com IA. Petições, contratos e pareceres com modelos prontos e validação de legislação.";
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2">
        <span className="text-white/40 text-xs flex items-center gap-1"><Share2 className="w-3 h-3" /> Compartilhar:</span>
        <a
          href={whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 hover:bg-[#25D366]/20 transition-colors"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-[#0A66C2]/10 text-[#0A66C2] border border-[#0A66C2]/20 hover:bg-[#0A66C2]/20 transition-colors"
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
      <span className="text-white/50 text-sm flex items-center gap-1.5">
        <Share2 className="w-4 h-4" /> Compartilhe com colegas advogados:
      </span>
      <div className="flex gap-3">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold bg-[#25D366] text-white hover:bg-[#1ebe5d] transition-all active:scale-[0.97] shadow-lg shadow-[#25D366]/20"
          aria-label="Compartilhar no WhatsApp"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold bg-[#0A66C2] text-white hover:bg-[#0958a8] transition-all active:scale-[0.97] shadow-lg shadow-[#0A66C2]/20"
          aria-label="Compartilhar no LinkedIn"
        >
    ...
    <section className="py-24 relative overflow-hidden" style={{ background: "#0f0f1a" }}>
      ...
      <div className="container relative z-10 text-center max-w-3xl mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeUp} custom={4} className="mt-10 pt-8 border-t border-white/10">
            <ShareButtons />
          </motion.div>
        </motion.div>
      </div>
  ...
  return (
    <footer className="border-t border-white/5 py-12" style={{ background: "#0a0a14" }}>
      <div className="container">
        ...
        <div className="border-t border-white/5 mt-8 pt-8 flex flex-col gap-4">
